...
$payment_status = Monetbil::STATUS_SUCCESS;?>
                ...
                <?php if (Monetbil::STATUS_SUCCESS == $payment_status): ?>
                    <div class="checkmark">
                        ...
                        <a href="http://localhost/taziya1/tuto3 html2pdf/index.php" class="btn btn-block btn-primary btn-sm m-t-20">Download ticket</a>
                    </div>
                <?php else: ?>
                    <p>Payment failed!</p>
                    <a href="http://localhost/taziya2/taziya1/index.php" class="btn btn-block btn-primary btn-sm m-t-20">Home page</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
